    ...
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100 p-6">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center gap-2">
          ...
          <p className="text-center text-sm text-green-700">Join the plant care community</p>
        </div>

        <Card className="border-green-200 shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl text-green-900">Create an account</CardTitle>
            <CardDescription>Get started with your plant care journey</CardDescription>
          </CardHeader>
          <CardContent>
